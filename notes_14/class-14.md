...

{
  ...
  increament = ( )=> 
  > **Note:**  after calling the increament method. caller object of the render function can use the scope for being arrow function.
  ...
  render( ) // this is the method property of the App class.
  {
    return( // upon the time of call. render function returns a html element.
      ...
      <div> // opening of a html tag.
        ...
        > **Note:**  upon click on button increament method will be called by the object that called the render function. React itself called this function and the object that called the render method can use the scope in the increament methods scope.
